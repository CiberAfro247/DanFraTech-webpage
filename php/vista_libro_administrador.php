	...
	<nav class="navbar navbar-custom navbar-expand-lg navbar-light">
      				...
      				<div class="row">
      					<div class="col-11">
      						<ul class="navbar-nav">
			          			...
			          			<li class="nav-item">
			            			<a class="nav-link a-custom" href="../html/Inicio_administrador.html">Inicio</a>
			          			</li>
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
									  	...
									  	<li><a class="dropdown-item " href="../html/eliminar_autores.html">Eliminar</a></li>
									  	<li><a class="dropdown-item " href="../html/modificar_autores.html">Modificar</a></li>
									</ul>
								</li>	
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
									  	<li><a class="dropdown-item " href="../html/ingresar_multas.html">Ingresar</a></li>
									  	<li><a class="dropdown-item " href="../html/baja_mod_multas.html">Modificar y Eliminar</a></li>
									</ul>
								</li>
						
								<li class="nav-item">
			            			<a class="nav-link a-custom" href="../html/resenias_administrador.html">Reseñar</a>
			          			</li>
								<li>
  	...
  	<div class="container">
        <div class="row">
            <div class="row no-gutters">
                ...
                <div class="col-md-9">
                  	<div class="card-body ">
	                   	...
	                   	<table>
	                   		<tr>
	                   			<td><p class="card-text" id="autor">Por <?php print($autor["Nombre_autor"]) ?></p></td>
	                   		</tr>
	                   		<tr>
	                   			<td>
		                   			<a>Puntaje
            ...
            <div class="col-md-3">             
            	<a href="../html/leer_administrador.html" id="prestamo" class="button button_books" value="Pedir Prestamo">Pedir Prestamo</a>
            </div>
        </div>
