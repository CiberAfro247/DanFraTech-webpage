...
function filaNuevaTerror(infoLibro, pos){
	var fila = "<div class='product' id='product1_" + pos + "'><a href='../php/vista_libro.php?isbn=" + infoLibro.ISBN + "'>" +
...
function filaNuevaFantasia(infoLibro, pos){
	var fila = "<div class='product' id='product2_" + pos + "'><a href='../php/vista_libro.php?isbn=" + infoLibro.ISBN + "'>" +
	"<img class='book' height='200px' src='" + infoLibro.Imagen + "'></a></div>"
...
function filaNuevaRomance(infoLibro, pos){
	var fila = "<div class='product' id='product3_" + pos + "'><a href='../php/vista_libro.php?isbn=" + infoLibro.ISBN + "'>" +
	"<img class='book' height='200px' src='" + infoLibro.Imagen + "'></a></div>"
...
function filaNuevaCienciaFiccion(infoLibro, pos){
	var fila = "<div class='product' id='product4_" + pos + "'><a href='../php/vista_libro.php?isbn=" + infoLibro.ISBN + "'>" +
	"<img class='book' height='200px' src='" + infoLibro.Imagen + "'></a></div>"
