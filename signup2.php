      ...
      <div class="col-md-12 art">
        ...
        <main class="form-signin w-100 m-auto">
          <form action="signup2.php" method="POST">
            ...
            <div class="form-floating">
              <input name="password" type="password" class="form-control" id="password" placeholder="Contraseña"></input>
            ...
            <div class="form-floating">
              <input name="confirm_password" type="password" class="form-control" id="confirm_password" placeholder="Contraseña"></input>
              <label for="confirm_password">Confirmar contraseña</label> 
            </div>  
            <br>

            <div class="centrado">
              <button class="button" type="submit" value="submit">Crear</button>
              <br>
              <br>
              <h1 class="h5 mb-1 fw-normal">Si ya tiene una cuenta creada presione <a href="login3.php">aqui</a></h1>
            </div>
          </form>
        </main>
      </div>
